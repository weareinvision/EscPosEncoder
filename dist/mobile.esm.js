...
var linewrap$1 = linewrap$2.exports = function (start, stop, params) {
...
linewrap$1.soft = linewrap$1;

linewrap$1.hard = function (/*start, stop, params*/) {
    ...
    return linewrap$1.apply(null, args);
};

linewrap$1.wrap = function(text/*, start, stop, params*/) {
    var args = [].slice.call(arguments);
    args.shift();
    return linewrap$1.apply(null, args)(text);
};

const iconv = lib.exports;
const linewrap = linewrap$2.exports;

/**
 * Create a byte stream based on commands for ESC/POS printers
 */
class EscPosEncoder$1 {
  /**
   * Create a new object
   *
...
var escPosEncoder = EscPosEncoder$1;
...
const EscPosEncoder = escPosEncoder;

const { createCanvas } = browser;
const Dither = canvasDither;
const Flatten = canvasFlatten;
